    ...
    return Column(
      children: [
        if (MediaQuery.of(context).size.height > 600)
          SizedBox(
            height: MediaQuery.of(context).size.height > 1200 ? 120 : 60,
          ),
        Container(
        ...
        Container(
          ...
          padding: const EdgeInsets.symmetric(horizontal: 15),
          child: Text(
            'Enter your phone number to verify your account and place order.',
  ...
  Widget sendOtpButton() {
    return GestureDetector(
      ...
      child: Container(
        width: 250,
        height: 60,
        decoration: BoxDecoration(color: Commons.bgColor, borderRadius: BorderRadius.circular(40)),
